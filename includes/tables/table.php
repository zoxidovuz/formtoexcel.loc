...
<div class="table-responsive">
    <table class="table table-striped">
        ...
        <tr>
            <th colspan="8">Annual Rental Income Received ( apportion rental income to each applicant as per % of property ownership) (Not to be refinanced)</th>
            <th ></th>
        </tr>
        ...
        <tr>
            <th colspan="8">Monthly property expenses ( apportion expenses to each applicant as per % of property ownership)</th>
            <th ></th>
        </tr>
